Public Class frmEasy
    Dim words() As String = {"potato", "tomato", "computer", "apartment", "forest", "chocolate", "lawyer"}
    ...
    Public Sub checkWord()
        ...
        If item = words.Length - 1 Then
            ...
            SaveScore("Easy", score)

            MessageBox.Show("Game finished! Score saved.", "Easy Mode", MessageBoxButtons.OK, MessageBoxIcon.Information)
        End If
