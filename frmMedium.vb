Public Class frmMedium
    Dim words() As String = {"noodle", "adjustment", "risk", "vulnerability", "development", "timetable", "assignment"}
    ...
    Public Sub checkWord()
        ...
        If item = words.Length - 1 Then
            ...
            SaveScore("Medium", score)

            MessageBox.Show("Game finished! Score saved.", "Medium Mode", MessageBoxButtons.OK, MessageBoxIcon.Information)
        End If
